...
namespace CifraShop.Domain.Repositories
{
    public interface IOrderRepository
    {
        ...
        Task<(List<Order> Items, int TotalCount)> GetAllPaged(int page, int pageSize, string? search = null, StatusOrder? status = null, DateTime? dateFrom = null, DateTime? dateTo = null, string? branch = null);
