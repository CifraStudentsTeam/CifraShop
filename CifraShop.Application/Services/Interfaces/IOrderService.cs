...
namespace CifraShop.Application.Services.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<PagedResponse<Order>> GetOrdersPaged(int page, int pageSize, string? search = null, StatusOrder? status = null, DateTime? dateFrom = null, DateTime? dateTo = null, string? branch = null);
        ...
        Task<Order> CreateOrder(string customerEmail, List<(int ProductId, int Quantity)> items, string branch = "");
